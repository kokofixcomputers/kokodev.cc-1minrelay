...
export default function Pricing() {
  const features = [
    { name: "Self-Hosted Option", free: true, lifetime: false, subscription: false, educational: false, selfHosted: true },
    { name: "Hosted Service", free: false, lifetime: true, subscription: true, educational: true, selfHosted: false },
    { name: "Priority Support", free: false, lifetime: true, subscription: true, educational: true, selfHosted: true },
    { name: "Text Generation", free: true, lifetime: true, subscription: true, educational: true, selfHosted: true },
    { name: "Image Generation", free: false, lifetime: true, subscription: true, educational: true, selfHosted: true },
    { name: "Text-To-Speech", free: false, lifetime: true, subscription: true, educational: true, selfHosted: true },
    { name: "Failover Nodes", free: false, lifetime: true, subscription: true, educational: true, selfHosted: false },
    { name: "Automatically updated model list", free: false, lifetime: true, subscription: true, educational: true, selfHosted: true },
    { name: "Commercial Use", free: true, lifetime: true, subscription: true, educational: false, selfHosted: true },
  ]
        ...
        <div className="grid md:grid-cols-5 gap-8 mb-16">
          <div className="card flex flex-col h-full">
            ...
            <a 
              ...
              className="btn-secondary w-full mt-auto mb-4"
            >
              GitHub
            </a>
          </div>

          <div className="card ring-2 ring-blue-500/20 flex flex-col h-full">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="btn-primary w-full mt-auto mb-4"
            >
              Buy Lifetime
            </a>
          </div>
          ...
          <div className="card flex flex-col h-full">
            ...
            <div className="text-3xl font-bold mb-2">$8 <span className="text-sm font-normal text-muted">one-time</span></div>
            <p className="text-muted mb-6">One-time purchase for self-hosted deployment with paid features.</p>
            <ul className="space-y-3 mb-8 text-sm">
              <li className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-green-500 rounded-full"></span>
                All features included
              ...
              <li className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-green-500 rounded-full"></span>
                No reliance on our hosted service
              </li>
            </ul>
            <a 
              target="_blank" 
              rel="noopener noreferrer"
              className="btn-primary w-full opacity-60 cursor-not-allowed pointer-events-none mt-auto mb-4"
              aria-disabled="true"
            >
              Coming soon
            </a>
            ...
            <tbody>
              {features.map((feature, index) => (
                <tr key={index}>
                  ...
                  <td>{feature.selfHosted ? <Check className="w-5 h-5 text-green-500" /> : <X className="w-5 h-5 text-red-500" />}</td>
                </tr>
              ))}
            </tbody>
          </table>
